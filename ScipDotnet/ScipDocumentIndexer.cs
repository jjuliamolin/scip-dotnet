...
public class ScipDocumentIndexer
{
    ...
    public void VisitOccurrence(ISymbol? symbol, Location location, bool isDefinition, SyntaxNode? declarationNode = null)
    {
        if (symbol == null)
        {
            return;
        ...
        if (isDefinition && declarationNode != null)
        {
            foreach (var range in LocationToRange(declarationNode.GetLocation()))
            {
